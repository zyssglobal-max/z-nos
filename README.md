...
└── 🌐 trck      // Se encarga de rastrear la versión mas utilizada del cliente ...
```
...
4. ¡Listo para usar!
   - [Probar Z-NOS](chat.html) V.HTML 1.8.0.0 - (READY) pc ...
   - [Probar Z-NOS](chat-reponsive.html) V.HTML 1.9.0.0 - (READY) pwa, reponsive ...
